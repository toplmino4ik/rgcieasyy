...
RESETS.crystal = {
    ...
    req: () => player.level.gte(81),
    get req_desc() { return `Reach Level 81` },

    name: "Crystallize",
    get reset_desc() {
        return `Resets everything prestige does as well as resetting tier to 5, prestige points, and prestige upgrades for crystals. Gain more crystals based on your tier.`
    },
    color: ['magenta','pink'],
