    ...
    grass: {
        ...
        ctn: {
            "1": {
                ...
                name: `Grass Value`,
                desc: `Increases grass value by <b class="green">+5000%</b> per level.<br>This effect is <b class="green">doubled</b> every <b class="yellow">25</b> levels.`,
                ...
                effect(a) {
                    let x = Decimal.pow(5000000,a.div(25).floor()).mul(a).add(1)
                    return x
                },
