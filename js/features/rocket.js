...
RESETS['rocket-part'] = {
    ...
    get reset_desc() {
        ...
        return `Reset everything liquefy does as well as oil, oil upgrades, steel, and total rocket fuel for rocket part and 2 momentum.
    ...
    success() {
        ...
        player.rocket.momentum = player.rocket.momentum.add(2)
    },
    doReset() {
