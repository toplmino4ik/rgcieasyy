    ...
    ctn: [
        { // 0
            ...
            get desc() { return `Unlocks <b class="green">Accomplishments</b>.<br>
                ...
                Increases grass value by <b class="green">+1000%</b> per grasshop.`
            },
            effect: a => a.mul(10).add(1),
        },{
            r: 2,
            get desc() { return `Increases experience gained by <b class="green">+1000%</b> per grasshop.` },
            effect: a => a.mul(10).add(1),
        },{
            r: 3,
            get desc() { return `Increases tier progress gained by <b class="green">+1000%</b> per grasshop.` },
            effect: a => a.mul(10).add(1),
        },{
            r: 4,
            ...
            r: 11,
            get desc() { return `Increases steel gained by <b class="green">+250%</b> per grasshop.<br>Unlocks two more generator upgrades related to charge.` },
            effect: a => a.mul(2.5).add(1),
        },{ // 10
            r: 12,
            ...
            r: 16,
            get desc() { return `Increases anti-grass value by <b class="green">+500%</b> per grasshop.` },
...
UPGRADES.factory = {
    ...
    ctn: {
        "1": {
            ...
            name: `Foundry`,
            desc: `Unlocks a building where you can upgrade steel production.<br>Increases foundry's effect by <b class="green">+50%</b> per level.`,
        ...
        "2": {
            ...
            name: `Generator`,
            desc: `Unlocks a building where you can upgrade prestige/crystal generation.<br>Increases generator's effect by <b class="green">+100%</b> per level.`,
