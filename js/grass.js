const GRASS = {
    field: {
        normal: {
            ...
            get cap() { return Decimal.add(100,upgradeEffect('grass',2,0)).add(upgradeEffect("perks",3,0)) },
        ...
        anti: {
            ...
            get grow_amount() { return 5 },
        
            get cap() { return Decimal.add(100,upgradeEffect('anti-grass',3,0)).add(upgradeEffect("anonymity",5,0)) },
