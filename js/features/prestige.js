CURRENCIES.prestige = {
    ...
    get gain() {
        ...
        let x = player.level.sub(25).pow_base(b).mul(player.grass.max(1).root(15)).mul(10)
...
RESETS.prestige = {
    ...
    req: () => player.level.gte(25),
    get req_desc() { return `Reach Level 25` },
...
UPGRADES.prestige = {
    ...
    ctn: {
        "1": {
            ...
            name: `Grass Value II`,
            tier: "II",
            desc: `Increases grass value by <b class="green">+50%</b> per level.<br>This effect is increased by <b class="green">+150%</b> every <b class="yellow">25</b> levels.`,
            ...
            effect(a) {
                let x = Decimal.pow(2.5,a.div(25).floor()).mul(a).mul(.5).add(1)
                return x
            },
        ...
        "2": {
            ...
            name: `XP II`,
            tier: "II",
            desc: `Increases experience gained by <b class="green">+50%</b> per level.<br>This effect is increased by <b class="green">+250%</b> every <b class="yellow">25</b> levels.`,
            ...
            effect(a) {
                let x = Decimal.pow(3.5,a.div(25).floor()).mul(a).mul(.5).add(1)
                return x
            },
            effDesc: x => formatMult(x),
        },
